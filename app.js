...
// Fix root path (/) - stops 502 on main URL
app.get('/', (req, res) => {
    res.send('Food DB API is running! 🚀 Endpoint: /foodmenu');
});

// Fix favicon - stops 502 on /favicon.ico
app.get('/favicon.ico', (req, res) => {
    res.status(204).end();  // 204 No Content = silent ignore
});
